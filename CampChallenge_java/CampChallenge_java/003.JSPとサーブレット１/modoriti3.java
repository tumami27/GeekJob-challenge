 ...
 * @author guest1Day
 */
@WebServlet(name = "modoriti3", urlPatterns = {"/modoriti3"})
public class modoriti3 extends HttpServlet {
String name[] = {"松本", "名前2", "名前3"};
     String birthday[] = {"９月２３", "生年月日2", "生年月日3"};
     String address[] = {"埼玉", "住所2", "住所3"};
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet modoriti3</title>");            
            out.println("</head>");
            out.println("<body>");
             out.print(person(1));
            out.println("</body>");
